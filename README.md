...
Также следует упомянуть что работаю над проектом уже после изучения stl библиотек и не удержался от их включения в проект. Если нужно, могу передать на проверку максимально простой код без их использования, если это нужно здесь представлена его "переделанная" версия.
